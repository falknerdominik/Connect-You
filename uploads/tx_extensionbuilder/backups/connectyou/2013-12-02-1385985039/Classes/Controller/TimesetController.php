...
class TimesetController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	 ...
	 * action new
	 *
	 * @param \TYPO3\Connectyou\Domain\Model\Timeset $newTimeset
	 * @dontvalidate $newTimeset
	 * @return void
	 */
	public function newAction(\TYPO3\Connectyou\Domain\Model\Timeset $newTimeset = NULL) {
	 ...
	 * @return void
	 */
	public function createAction(\TYPO3\Connectyou\Domain\Model\Timeset $newTimeset) {
	 ...
	 * @return void
	 */
	public function editAction(\TYPO3\Connectyou\Domain\Model\Timeset $timeset) {
	 ...
	 * @return void
	 */
	public function updateAction(\TYPO3\Connectyou\Domain\Model\Timeset $timeset) {
	 ...
	 * @return void
	 */
	public function deleteAction(\TYPO3\Connectyou\Domain\Model\Timeset $timeset) {
