...
class Assignment extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	 ...
	 * role
	 *
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Role>
	 */
	protected $role;
	 ...
	 * project
	 *
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Project>
	 */
	protected $project;
	 ...
	 * @return void
	 */
	public function addRole(\TYPO3\Connectyou\Domain\Model\Role $role) {
	 ...
	 * Removes a Role
	 *
	 * @param \TYPO3\Connectyou\Domain\Model\Role $roleToRemove The Role to be removed
	 * @return void
	 */
	public function removeRole(\TYPO3\Connectyou\Domain\Model\Role $roleToRemove) {
	 ...
	 * Returns the role
	 *
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Role> $role
	 */
	 ...
	 * Sets the role
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Role> $role
	 * @return void
	 */
	 ...
	 * @return void
	 */
	public function addProject(\TYPO3\Connectyou\Domain\Model\Project $project) {
	 ...
	 * Removes a Project
	 *
	 * @param \TYPO3\Connectyou\Domain\Model\Project $projectToRemove The Project to be removed
	 * @return void
	 */
	public function removeProject(\TYPO3\Connectyou\Domain\Model\Project $projectToRemove) {
	 ...
	 * Returns the project
	 *
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Project> $project
	 */
	 ...
	 * Sets the project
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\TYPO3\Connectyou\Domain\Model\Project> $project
	 * @return void
	 */
