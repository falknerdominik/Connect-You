...
class AssignmentController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	 ...
	 * @return void
	 */
	public function showAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $assignment) {
	 ...
	 * action new
	 *
	 * @param \TYPO3\CyMarketplace\Domain\Model\Assignment $newAssignment
	 * @dontvalidate $newAssignment
	 * @return void
	 */
	public function newAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $newAssignment = NULL) {
	 ...
	 * @return void
	 */
	public function createAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $newAssignment) {
	 ...
	 * @return void
	 */
	public function editAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $assignment) {
		$this->view->assign('assignment', $assignment);
	}
	 ...
	 * @return void
	 */
	public function updateAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $assignment) {
	 ...
	 * @return void
	 */
	public function deleteAction(\TYPO3\CyMarketplace\Domain\Model\Assignment $assignment) {
