...
#
# Table structure for table 'tx_cymarketplace_domain_model_timeset'
#
CREATE TABLE tx_cymarketplace_domain_model_timeset (
...
#
# Table structure for table 'tx_cymarketplace_domain_model_assignment'
#
CREATE TABLE tx_cymarketplace_domain_model_assignment (
...
#
# Table structure for table 'tx_cymarketplace_domain_model_role'
#
CREATE TABLE tx_cymarketplace_domain_model_role (
...
#
# Table structure for table 'tx_cymarketplace_domain_model_project'
#
CREATE TABLE tx_cymarketplace_domain_model_project (
